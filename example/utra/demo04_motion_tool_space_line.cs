...
namespace example.utra
{
    class Program4
    {
        static void _Main(string[] args)
        {
            ...
            speed = 20.0f;
            acc = 10000.0f;
            int ret9 = ubot.moveto_cartesian_line(pos1, speed, acc, 60);
            Console.WriteLine("[UbotApi ] moveto_cartesian_line  ret: " + ret9.ToString());
            int ret6 = ubot.moveto_cartesian_line(pos2, speed, acc, 60);
            Console.WriteLine("[UbotApi ] moveto_cartesian_line  ret: " + ret6.ToString());
            int ret7 = ubot.moveto_cartesian_line(pos3, speed, acc, 60);
            Console.WriteLine("[UbotApi ] moveto_cartesian_line  ret: " + ret7.ToString());
        }
    }
}
