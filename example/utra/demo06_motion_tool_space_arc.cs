...
namespace example.utra
{
    class Program6
    {
        static void _Main(string[] args)
        {
            ...
            speed = 50.0f;
            acc = 100.0f;
            int ret9 = ubot.moveto_cartesian_line(pos3, speed, acc, 5.0f);
            Console.WriteLine("[UbotApi ] moveto_cartesian_line  ret: " + ret9.ToString());

            int ret6 = ubot.moveto_cartesian_circle(pos1, pos2, speed, acc, 5.0f, 50);
            Console.WriteLine("[UbotApi ] moveto_cartesian_circle  ret: " + ret6.ToString());
            int ret7 = ubot.moveto_cartesian_circle(pos2, pos3, speed, acc, 5.0f, 100);
            Console.WriteLine("[UbotApi ] moveto_cartesian_circle  ret: " + ret7.ToString());
            int ret8 = ubot.moveto_cartesian_circle(pos2, pos1, speed, acc, 5.0f, 125);
            Console.WriteLine("[UbotApi ] moveto_cartesian_circle  ret: " + ret8.ToString());
        }
    }
}
